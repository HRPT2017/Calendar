...
namespace Calendar
{
    public class DataContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder opitionsBuilder)
        {
            ...
            opitionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\hugo1\\OneDrive\\Ambiente de Trabalho\\Hugo\\Trabalho\\Calendar\\Calendar\\Calendar.mdf\";Integrated Security=True");
        }
